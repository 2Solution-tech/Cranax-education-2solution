            ...
            <div class="max-w-6xl mx-auto text-white bg-gradient-to-r from-purple-800 to-indigo-800 rounded-lg">
                <div class="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
                    <div>
                        ...
                        <p class="text-sm text-gray-400 mt-3">Feel free to reach out to us with any questions, feedback, or inquiries. Fill out the form , and we will get back to you as soon as possible.</p>
                        <ul class="mt-12 space-y-8">
                            <li class="flex items-center">
                                ...
                                <a href="javascript:void(0)" class="text-white text-sm ml-3">
                                    <strong>support@cranax.in</strong>
                                </a>
                            </li>
                            <li class="flex items-center">
                                ...
                                <a href="javascript:void(0)" class="text-white text-sm ml-3">
                                    <strong>8303771960 , 6394409026</strong>
                                </a>
                            </li>
                            <li class="flex items-center">
                                ...
                                <a href="javascript:void(0)" class="text-white text-sm ml-3">
                                    <strong>3rd Floor, Devidas Enterprises, Hardoi Rd, next to Shreya J, Tahseen Ganj, Chowk, Lucknow, Uttar Pradesh 226003
</strong>
                                </a>
                            </li>
                        </ul>
